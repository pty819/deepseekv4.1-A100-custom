"""
cb3_sim.py -- copied verbatim from the DGX Spark project (gx10-b872:~/dsv41-spark/work/engine/
codebook_sim.py) so the A100 can score that exact format against the dim-4 VQ under one protocol.

--- original docstring ---
 simulate a lower-bit expert format WITHOUT a new kernel or packing.
